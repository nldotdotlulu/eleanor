...
echo '';
bash -c "curl -L https://get.oh-my.fish | fish; exit";
echo '';
...
bash -c "$(wget -qO- https://git.io/vQgMr); 03;";
echo '';
...
echo '';
wget https://updates.insomnia.rest/downloads/ubuntu/latest?ref=https%3A%2F%2Fwww.google.com%2F&app=com.insomnia.designer;
sudo dpkg -i Insomnia.Designer-2020.3.3.deb;
wget https://updates.insomnia.rest/downloads/ubuntu/latest?ref=https%3A%2F%2Fwww.google.com%2F&app=com.insomnia.app;
...
echo '';
fish -c "omf install cideM/fish-yvm";
echo '';
